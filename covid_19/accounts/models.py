...
class User(AbstractBaseUser, PermissionsMixin):
	...
	Country = models.CharField(max_length = 30, choices = COUNTRIES, null=True)
	Sickness = models.CharField(max_length = 30 , choices = SICKNES, null=True)
	Gender = models.CharField(max_length = 30,  choices = GENDER_CHOICES, null=True )
	Smoking = models.CharField(max_length = 30,  choices = SMOKE, null=True )
	...
	def full_name(self):
		...
		return str("{0} {1}".format(self.first_name, self.last_name)).capitalize()
