# Generated by Django 3.1.5 on 2021-07-14 13:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='Sickness',
            field=models.CharField(choices=[('Asthma', 'Asthma'), ('Lung Cancer', 'Lung Cancer'), ('Heart disease', 'Heart disease'), ('Tuberculosis', 'Tuberculosis'), ('diabetic', 'diabetic'), ('Blood disorders', 'Blood disorders'), ('Cancers', 'Cancers'), ('HIV', 'HIV'), ('Kidney disease', 'Kidney disease')], max_length=30, null=True),
        ),
        migrations.AlterField(
            model_name='user',
            name='Smoking',
